...
import PortraitOil3 from "../../images/galery/portrait/oil/3.jpg";
...
import Image11 from "../../images/galery/images/11.jpg";
...
const portraitOil = [PortraitOil1, PortraitOil2, PortraitOil3, PortraitOil4, PortraitOil5, PortraitOil6, PortraitOil7, PortraitOil8];
...
const images = [Image1, Image2, Image3, Image4, Image5, Image6, Image7, Image8, Image9, Image10, Image11, Image12, Image13, Image14, Image15, Image16, Image17, Image18, Image19, Image20, Image21, Image22, Image23, Image24, Image25, Image26, Image27, Image28];

const studyChildren = [StudyChildren1, StudyChildren2, StudyChildren3, StudyChildren4, StudyChildren5, StudyChildren6, StudyChildren7, StudyChildren8, StudyChildren9, StudyChildren10, StudyChildren11, StudyChildren12, StudyChildren13, StudyChildren14, StudyChildren15, StudyChildren16, StudyChildren17, StudyChildren18, StudyChildren19, StudyChildren20]
const studyParents = [StudyParents1, StudyParents2, StudyParents3, StudyParents4, StudyParents5, StudyParents6, StudyParents7, StudyParents8, StudyParents9, StudyParents10];
...
const Galery = () => {
    ...
    return selectedAlbum ? <>
        ...
        <AlbumWrapper title="Мастер-класс(дети)" image={StudyChildren15} onClick={() => setSelectedAlbum({ images: studyChildren, title: "Мастер-класс(дети)" })} />
        ...
        <AlbumWrapper title="Пейзаж" image={Life1} onClick={() => setSelectedAlbum({ images: life, title: "Пейзаж" })} />
